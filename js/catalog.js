const Catalog = {
    ...
    mapApiProductToCatalog(product) {
        ...
        const displayCategory = normalizedPrice >= this.HIGH_APPAREL_PRICE
        ...
        return {
            ...
            category: this.BASE_APPAREL_LABEL,
            displayCategory,
            description,
    ...
    async loadProductsFromApi() {
        try {
            ...
            this.setCatalogData([this.BASE_APPAREL_LABEL], mappedProducts);
            return true;
        } catch (error) {
