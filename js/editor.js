...
const Editor = {
    products: [
        ...
        },
        {
            ...
            printArea: { top: 36, left: 50, width: 58, height: 28, radius: 18 },
            formats: [
                { id: 'metal-wrap', label: 'Панорама 360', widthMm: 200, heightMm: 85, width: 66, height: 30, note: 'Панорамний принт майже по колу чашки.' },
                { id: 'metal-center', label: 'Стандарт', widthMm: 180, heightMm: 80, width: 58, height: 28, note: 'Центральна зона для фото або слогану.' },
                { id: 'metal-left', label: 'Ліворуч', widthMm: 90, heightMm: 80, width: 28, height: 28, left: 36, note: 'Лого ліворуч від ручки.' },
                { id: 'metal-right', label: 'Праворуч', widthMm: 90, heightMm: 80, width: 28, height: 28, left: 64, note: 'Лого праворуч від ручки.' }
            ]
        },
        {
            id: 'mug-thermo',
    ...
    updateProductMeta(product) {
        ...
        this.elements.selectedProductChip.textContent = product.name;
        this.elements.selectedProductName.textContent = `${product.name} для кастомного друку`;
        this.elements.previewDetailProduct.textContent = product.name;
        this.elements.previewProductPill.innerHTML = `<i class="fa-solid ${product.icon}"></i>${product.name}`;
